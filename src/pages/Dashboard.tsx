...
import SensorDataMonitor from "@/components/Dashboard/SensorDataMonitor";
...
import { Baby, Loader2, LineChart, Radio, AlertTriangle } from "lucide-react";
      ...
      <div className="mb-8">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">Real-time IoT Monitoring</CardTitle>
            <CardDescription>Live readings from ESP32 sensors</CardDescription>
          </CardHeader>
          <CardContent>
            <SensorDataMonitor animalId={selectedAnimal} />
          </CardContent>
        </Card>
      </div>
